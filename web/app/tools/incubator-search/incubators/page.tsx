            ...
            {open && (
                <div className="mb-8 pt-4 border-t border-white/10 animate-fade-in">
                    <ul className="space-y-3">
                        ...
                        <li className="text-sm text-text-secondary font-light flex justify-between gap-4 border-b border-white/5 pb-2">
                            <span className="shrink-0 text-white font-medium">Capacity:</span>
...
export default function IncubatorsPage() {
    ...
    // Only map incubators and coworking spaces here
    const allData = westernLineData.filter(item => item.type.toLowerCase().includes('incubator') || item.type.toLowerCase().includes('coworking'));
        ...
        <div className="pt-32 pb-20 min-h-screen bg-[#000000]">
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="text-center mb-16 max-w-3xl mx-auto border-b border-white/10 pb-12">
                    <span className="text-accent-blue text-xs font-bold tracking-[0.2em] uppercase mb-4 block">Incubators & Spaces</span>
                    ...
                    <p className="text-lg md:text-xl text-text-secondary font-light">
                        Find the best locations to scale your hardware or software startup.
                    </p>
                </div>
                ...
                {filteredData.length > 0 ? (
                    ...
                    <div className="glass-card p-16 rounded-3xl border border-dashed border-white/10 text-center flex flex-col items-center justify-center min-h-[400px]">
                        ...
                        <p className="text-text-secondary mb-8">No incubators matched this specific query setup.</p>
